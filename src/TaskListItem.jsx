    ...
    return (
        <li className={`list-group-item ${task.isDone && 'bg-success bg-gradient'}`} >
            ...
            <div className="btn-group float-end" role="group">
                <button className="btn btn-sm btn-success" onClick={() => doneTask(task.uuid)}>Bitti</button>
                <button className="btn btn-sm btn-info" onClick={() => editTask(task.uuid)}>Duzenle</button>
